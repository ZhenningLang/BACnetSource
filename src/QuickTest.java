...
public class QuickTest {
    ...
    public static void main(String[] args) throws Exception {
        network = new IpNetwork("10.2.141.61");
        transport = new Transport(network);
        localDevice = new LocalDevice(601, transport);
...
//            }
    ...
    static void sendWhoIs() throws BACnetException {
        Address bcastAddr = new Address(InetAddrCache.get(network.getBroadcastIp(), 0xBAC0));
